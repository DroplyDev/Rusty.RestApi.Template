...
namespace Rusty.Template.Tests.Integration
{
	...
	public partial class NSwagClient
	{
		...
		public virtual async System.Threading.Tasks.Task<SwaggerResponse<TokenResponse>> LoginAsync(LoginRequest body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
		{
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 401)
						{
							...
							throw new SwaggerException<string>("Login or password is incorrect", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						if (status_ == 400)
						{
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 202)
						{
							...
							throw new SwaggerException<string>("Access token has not expired yet", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						if (status_ == 401)
						{
							...
							throw new SwaggerException<string>("Refresh token is expired", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						if (status_ == 400)
						{
		...
		public virtual async System.Threading.Tasks.Task<SwaggerResponse<UserUpdateDto>> GetUserToUpdateByIdAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
		{
			...
			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append("api/v1/users/update/{id}");
			urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
		...
		/// <returns>User retrieved successfully</returns>
		/// <exception cref="SwaggerException">A server side error occurred.</exception>
		public virtual async System.Threading.Tasks.Task<SwaggerResponse<UserUpdateDto>> GetUserToUpdateByUsernameAsync(string username, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
		{
			if (username == null)
				throw new System.ArgumentNullException("username");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append("api/v1/users/update/{username}");
			urlBuilder_.Replace("{username}", System.Uri.EscapeDataString(ConvertToString(username, System.Globalization.CultureInfo.InvariantCulture)));
